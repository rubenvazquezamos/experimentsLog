...
`wavegHRslit`
First approach to comparing TMM and numerical results for a slit with a side-branch HR. Doesn't feature retrieval of $R$ from numerical scattered pressure. That's the next step. $S_w$ is the cross section of the main waveguide that the slit is loaded into in series.
>[!Plots]-
>![[geo.svg]]
>![[impedance.svg]]
