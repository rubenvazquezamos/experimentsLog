...
**Conclusion:** this doesn't seem to be the case! See the experiment `paramRepsQRD5` in the section about the effect of [[Factors affecting the diffusion coefficient of Schroeder diffusers#Experiments#Panel repetitions#paramRepsQRD5]] on the diffusion coefficient. It shows that the phase agreement improves when periodicity is present, but the diffusion coefficient agreement does not.
