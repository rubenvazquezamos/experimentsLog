...
**Conclusion:** this doesn't seem to be the case! See this experiment about the [[Writing/Factors affecting the diffusion coefficient of Schroeder diffusers###paramRepsQRD5|effect of repetitions on the diffusion coefficient]]. It shows that the phase agreement improves when periodicity is present, but the diffusion coefficient agreement does not.
# Experiments
